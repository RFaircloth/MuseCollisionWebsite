...
<!--- 		<div class="module_100" id="large_photo_container">
		...
		<!--- <div class="module_100"> --->
					...
					<div id="about_us_content_container">
						...
						<p>Muse Collision Center, formerly Southeast Collision in Hinesville was founded on
							four simple standards: Honesty, Integrity, Quality repairs, and Customer Service.</p>

						<div class="about_us_before_after_left"></div>
						<div class="about_us_before_after_right"></div>
						...
						<p>Muse Collision Center technicians are I-Car trained and ASE certified. These independent
							organizations offer training and certification programs to ensure technicians are up-to-date
							on the latest collision repair techniques and safety standards. Muse Collision Center is
							the only Collision Center in the Hinesville area that is I-Car Gold Certified. We are
							dedicated to continuing our training in Collision Repair as vehicles and repair methods
							continue to change each year.</p>

						

					</div> <!--- [ #about_us_content_container ] --->
