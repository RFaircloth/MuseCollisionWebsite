...
<head>
		...
		<cfset qGetAllCustomerComments 		= createObject('common_data_access.customer_comments.customer_comments').mGetAllCustomerComments(site_id='#qGetSiteMetaData.site_id#', site_dsn='#qGetSiteMetaData.site_dsn#') />
...
<!--- 		<div class="module_100" id="large_photo_container">
			...
			<div id="large_photo">
				...
				<div id="large_photo_message">
					...
					<div id="customer_comments_content_container">

						<h4 id="customer_comments_heading">Customer Comments</h4>

						<cfoutput query = "qGetAllCustomerComments" >

							<p class="customer_comments_text">#replace(comments, '#chr(13)#', '<br/>', 'all')#
								<span class="customer_comments_tag">#customer_tag#</span></p>

							<br/>

						</cfoutput>

					</div> <!--- [ customer_comments_content_container ] --->
