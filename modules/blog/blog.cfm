...
<head>
		...
		<cfset qGetBlog 			= createObject('common_data_access.blog.blog').mGetBlog(site_id='#qGetSiteMetaData.site_id#', site_dsn='#qGetSiteMetaData.site_dsn#') />
		<!--- <cfset qGetBlog	= createObject('#application.modulesCFCPath#.blog.blog').mGetBlog(site_dsn='#application.dsn#') /> --->
			...
			<div id="large_photo">
				...
				<div id="large_photo_message">
					...
					<div id="blog_content_container">
						...
						<h4 id="blog_heading">Muse News</h4>

							<cfoutput query = "qGetBlog">

								<div class="blog_entry_content_container">

									<img class="blog_heading_image" src="/site_wide_assets/images/#blog_post_image_320#"/>

									<p class="blog_title">#blog_post_title#</p>
									<p class="blog_author">#blog_post_author#<span class="blog_date_time">, #dateFormat(blog_post_date_entered, 'mmm d, yyyy')#, #timeFormat(blog_post_date_entered, 'h:mm tt')#</span></p>
									<br/>
									<p class="byline">#blog_post_byline#</p>
									<br/>
									<p><a class="view_hide_blog_link" href="" onClick="return false;">view article</a></p>
									<div style="clear:both;"></div>
									<p class="hidden_blog_article">
										#replace(blog_post_text, '#chr(13)#', '<br/>', 'all')#</p>

									<br/>
									<br/>

								</div> <!--- [ blog_entry_content_container ] --->
